...
export const EVENT_CARDS: EventCard[] = [
  ...
  { id: "eff-6", band: "efficiency", status: "mixed", headline: "이미 자산 있는 사람들 순자산 빠르게 증가", body: "세금 부담이 준 만큼, 주식·부동산을 가진 사람들의 순자산이 빠르게 불어났습니다." },

  // 균형
  { id: "bal-1", band: "balance", status: "good", headline: "직업 재교육 프로그램 확대", body: "기회 투자형 예산 덕분에 실직자를 위한 재교육 프로그램이 늘었습니다." },
  { id: "bal-2", band: "balance", status: "mixed", headline: "최저임금 소폭 인상, 자영업자는 부담 호소", body: "최저임금이 점진적으로 올랐지만, 소상공인은 인건비 부담을 호소합니다." },
  ...
  { id: "sec-6", band: "security", status: "mixed", headline: "\"세금이 투자를 위축시킨다\" 산업계 우려", body: "능력에 따른 세부담이 커지자, 일부 기업이 투자와 채용 계획을 줄이겠다고 밝혔습니다." },
];
