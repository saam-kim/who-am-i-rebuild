...
// 밴드(효율/균형/보장)마다 정확히 5장 — 긍정 2 · 경고 2 · 혼합 1로 고정 구성한다.
// pickEventCards가 뽑는 개수와 밴드별 카드 수를 맞춰서, 무작위 셔플만으로도
// 항상 긍정·부정·혼합이 균형 있게 섞이도록 한다(셔플만으로는 균형이 보장 안 됨).
export const EVENT_CARDS: EventCard[] = [
  // 효율지향
  { id: "eff-1", band: "efficiency", status: "good", headline: "기업 투자 활발, 일자리 증가", body: "낮은 세금 덕분에 기업 투자가 늘고 채용이 활발해졌습니다." },
  { id: "eff-7", band: "efficiency", status: "good", headline: "창업 늘고 소비 심리 회복", body: "세금 부담이 줄고 시장 자율성이 커지면서 새로 창업하는 사람들이 늘고, 소비 심리도 살아났습니다." },
...
export function pickEventCards(band: Orientation, count = 5, rng: () => number = Math.random): EventCard[] {
